    ...
    public static class ZuneTagContainerFactory
    {
        ...
        public static TagContainer CreateContainerWithThreeZuneTags()
        {
            ...
            container.Add(new PrivateFrame(MediaIds.ZuneAlbumArtistMediaID,
                                           new Guid("3ed50a00-0600-11db-89ca-0019b92a3933").ToByteArray()));
            container.Add(new PrivateFrame(MediaIds.ZuneAlbumMediaID,
                                           new Guid("4f66ff01-0100-11db-89ca-0019b92a3933").ToByteArray()));
            container.Add(new PrivateFrame(MediaIds.ZuneMediaID,
                                           new Guid("5366ff01-0100-11db-89ca-0019b92a3933").ToByteArray()));
        ...
        /// <summary>
        /// Note: this contains an incorrect guid to test for incorrectness
        /// </summary>
        /// <returns></returns>
        public static TagContainer CreateContainerWithOneZuneTag()
        {
            var container = ID3Tag.Id3TagFactory.CreateId3Tag(TagVersion.Id3V23);
